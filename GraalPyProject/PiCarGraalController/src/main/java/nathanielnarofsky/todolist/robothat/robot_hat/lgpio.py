...
#from .lgpio import lgpio
#I need to rewrite the functions that use lgpio to call java functions instead
#I also need to write a java class that implements that calls the C functions called in this file
import java
from nathanielnarofsky.todolist import lgpio as Lgpio


from .initialize import SPI
