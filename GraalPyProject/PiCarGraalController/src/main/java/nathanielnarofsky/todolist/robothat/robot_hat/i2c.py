...
#I need to implement the java class that wraps the underlying C SMBus functions

#from java.nathanielnarofsky.todolist import SMBCaller

# Import Java SMBusWrapper 
...
class I2C(_Basic_class):
    ...
    def scan(self):
        ...
        _, output = self._smbus.run_command(cmd)
