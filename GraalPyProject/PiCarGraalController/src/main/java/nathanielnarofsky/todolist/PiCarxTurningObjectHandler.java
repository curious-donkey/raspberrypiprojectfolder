...
public class PiCarxTurningObjectHandler {
    ...
    public PiCarxTurningObjectHandler() {
        createPiCarxObject();
    }
    ...
    public void turnLeft() {
        System.out.println("Executing turnLeft command via GraalPy");
    }

    public void turnRight() {
        System.out.println("Executing turnRight command via GraalPy");
    }
