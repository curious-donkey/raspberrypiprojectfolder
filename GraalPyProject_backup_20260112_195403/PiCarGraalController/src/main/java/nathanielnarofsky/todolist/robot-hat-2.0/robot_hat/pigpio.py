...
from java.nathanielnarofsky.todolist import PiGPio
...
class PiGPIOFactory(PiFactory):
    ...
    * Your script itself doesn't require root privileges; it just needs to
    ...
    def __init__(self, host=None, port=None):
        ...
        self._connection = PiGPio()
        #to establish a communication link with creation of Java object which talks to pigpio via Foreign Function and Memory API
        #much faster and more secure than using sockets
        #pigpio.pi(host, port)
